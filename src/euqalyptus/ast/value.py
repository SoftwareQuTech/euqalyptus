...
from euqalyptus.errors import UnknownTypeError, OperandMismatchError
...
class QoalaArray(
    ...
    def store(
        ...
        if isinstance(new_element, self.base_type):
            ...
            to_add = new_element
        from euqalyptus.ast.operations.arrays import SetItem
    ...
    def __getitem__(self, item_index: QoalaExpression | int) -> QoalaExpression:
        from euqalyptus.ast.operations.arrays import CastToIndex
        ...
        from euqalyptus.ast.operations.arrays import GetItem
