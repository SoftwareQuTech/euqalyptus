...
from euqalyptus.ast.operations.casts import FloatToInt
from euqalyptus.ast.operations.numeric import Pow2, Divide, Multiply
from euqalyptus.ast.value import QoalaInteger, QoalaFloat, QoalaNumericValue
from euqalyptus.utils.debug_info import DebugInfo, get_debug_info
...
class QubitBaseOperations(QoalaQubit, ABC):
    ...
    def rot_X(
        ...
        from euqalyptus.ast.operations.quantum import RotateX
    ...
    def rot_Y(
        ...
        from euqalyptus.ast.operations.quantum import RotateY
    ...
    def rot_Z(
        ...
        from euqalyptus.ast.operations.quantum import RotateZ
    ...
    def cnot(self, target: Self) -> QoalaOperation:
        from euqalyptus.ast.operations.quantum import CNotGate
    ...
    def cphase(self, target: Self) -> QoalaOperation:
        from euqalyptus.ast.operations.quantum import CPhaseGate
