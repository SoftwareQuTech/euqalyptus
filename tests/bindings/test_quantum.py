...
class TestQoalaHIRPythonBindingsQuantum:
    def test_complex_program_to_qoala_hir(self):
        ...
        # TODO - In the HIR dialect, we still get the weird syntax when creating quantum operations.
        #  We need to investigate why this happens. Maybe it is related with the fact that the qubit type is not known?
        expected_asm = """module {
